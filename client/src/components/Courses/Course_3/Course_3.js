  ...
  return (
    ...
    <div className="course-page">
      <div className="course-image-container">
        <img className="course-image" src="https://nareshit.com/wp-content/uploads/2018/09/C-plus-plus-online-training-nareshit.jpg" alt="Course" />
      </div>
      <div className="course-info">
        <h1 className="course-title">C++ Course</h1>
        ...
        <a href="/c3"><button className="buy-button">Start Course</button></a>
