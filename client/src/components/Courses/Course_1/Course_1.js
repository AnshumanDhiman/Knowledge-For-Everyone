  ...
  return (
    ...
    <div className="course-page">
      <div className="course-image-container">
        <img className="course-image" src="https://bs-uploads.toptal.io/blackfish-uploads/components/seo/content/og_image_file/og_image/1129719/cold-dive-into-react-native-a-beginners-tutorial-922a625efe84a4c2d782343b333b0bdb.png" alt="Course" />
      </div>
      <div className="course-info">
        <h1 className="course-title">React.js Course</h1>
        ...
        <a href="/c1"><button className="buy-button">Start Course</button></a>
