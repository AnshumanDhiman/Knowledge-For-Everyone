  ...
  return (
    ...
    <div className="course-page">
      <div className="course-image-container">
        <img className="course-image" src="https://viit.pk/frontend/img/android-app-development.png" alt="Course" />
      </div>
      <div className="course-info">
        <h1 className="course-title">Android App Development Course</h1>
        ...
        <a href="/c5"><button className="buy-button">Start Course</button></a>
