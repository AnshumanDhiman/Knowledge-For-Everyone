  ...
  return (
    ...
    <div className="course-page">
      <div className="course-image-container">
        <img className="course-image" src="https://www.traininginbangalore.com/images/infographics/ui-ux-training-in-bangalore-tib.jpg" alt="Course" />
      </div>
      <div className="course-info">
        <h1 className="course-title">UI/UX Designing Course</h1>
        ...
        <a href="/c6"><button className="buy-button">Start Course</button></a>
