  ...
  return (
    ...
    <div className="course-page">
      <div className="course-image-container">
        <img className="course-image" src="https://www.cbitss.in/wp-content/uploads/2018/12/java-training-in-chandigarh.png" alt="Course" />
      </div>
      <div className="course-info">
        <h1 className="course-title">Java Course</h1>
        ...
        <a href="/c4"><button className="buy-button">Start Course</button></a>
